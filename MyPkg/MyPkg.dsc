...
#################Homework#######################################
    ...
    MyPkg/Application/PCIList/PCIList.inf
    MyPkg/Application/PCIdump/PCIdump.inf

####CMOS_TOOLS##################################################
    MyPkg/Application/RTC/RTC.inf
    MyPkg/Application/CMOS/CMOS.inf

####CPU_TOOLS###################################################
    MyPkg/Application/MSR/MSR.inf
    MyPkg/Application/CPU/CPU.inf
...
####ACPI_TOOLS###################################################
    MyPkg/Application/ACPI_Get_DSDT/ACPI_Get_DSDT.inf
################################################################
#
